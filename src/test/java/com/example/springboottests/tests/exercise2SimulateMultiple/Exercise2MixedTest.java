package com.example.springboottests.tests.exercise2SimulateMultiple;
...
public class Exercise2MixedTest extends BaseTest {
    ...
    @Test
    public void editBoxAssertTextFromPWOnlyInFirst() {
        String trail = "";
    ...
    @Test
    public void editBoxAssertTextFromPWOnlyInFirstTwo() {
        String trail = "";
        for (int i = 0; i < CYCLES; i++) {
            String valueToFill = UUID.randomUUID().toString().substring(0, 2);
            seleniumPage.fillTextInputUsingSelenium(valueToFill);
    ...
    @Test
    public void editBoxAssertTextFromPWOnlyInFirstThree() {
        String trail = "";
        for (int i = 0; i < CYCLES; i++) {
            String valueToFill = UUID.randomUUID().toString().substring(0, 2);
            seleniumPage.fillTextInputUsingSelenium(valueToFill);
    ...
    @Test
    public void editBoxAssertTextFromPWAll() {
        String trail = "";
        for (int i = 0; i < CYCLES; i++) {
            String valueToFill = UUID.randomUUID().toString().substring(0, 2);
            seleniumPage.fillTextInputUsingSelenium(valueToFill);
